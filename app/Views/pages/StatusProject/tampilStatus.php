...
<head>
   <!-- link style css -->
   <link rel="stylesheet" href="../../assets/css/styleTampilStatus.css" />
...
<body>
   ...
   <section id="sidebar">
      ...
      <ul class="side-menu top">
         ...
         <li class="-">
            <a href="../ClientCompany/tampilClientCompany.html">
         ...
         <li class="-">
            <a href="../Position/tampilPosition.html">
               <i class="fa-sharp fa-solid fa-user-tie"></i>
               <span class="text">Position</span>
            </a>
         </li>
         <li class="-">
            <a href="../Division/tampilDivision.html">
               <i class="fa-solid fa-users"></i>
               <span class="text">Division</span>
            </a>
         </li>
         <li class="-">
            <a href="../Role/tampilRole.html">
   ...
   <section id="content">
      ...
      <nav>
         ...
         <a class="btn-log" href="#">
            <button>
               Logout
               <i class="fa-sharp fa-solid fa-arrow-right-from-bracket"></i></button></a>
      </nav>
      <!-- NAVBAR -->
   ...
   <!-- CONTENT -->
   <script src="jsTampilStatus.js"></script>
</body>
